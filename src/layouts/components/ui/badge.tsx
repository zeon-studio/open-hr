...
const badgeVariants = cva(
  "inline-flex capitalize items-center rounded-md border px-2.5 py-1 font-medium text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
