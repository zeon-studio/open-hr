    ...
    >
      ...
      <div className="row justify-between items-center">
        <div className="lg:col-6 mb-4">
          ...
          <div className="p-2 bg-gray-50 rounded">{courseData.platform}</div>
        </div>
        <div className="lg:col-6 mb-4">
          <div className="font-medium mb-1">Website</div>
          <div className="p-2 bg-gray-50 rounded">{courseData.website}</div>
        </div>
        <div className="lg:col-6 mb-4">
          <div className="font-medium mb-1">Email</div>
          <div className="p-2 bg-gray-50 rounded">{courseData.email}</div>
        </div>
        <div className="lg:col-6 mb-4">
          <div className="font-medium mb-1">Password</div>
          <div className="p-2 bg-gray-50 rounded">{courseData.password}</div>
        </div>
